...
{
    public class UserSocialDetailsVM : UserSignUpVM
    {
        ...
        public Dictionary<int, string> listIncomeRange { get; set; }
        public Dictionary<int, string> ListYesNo { get; set; }
        public Dictionary<int, string> ListLanguages { get; set; }
        public Dictionary<int, string> ListDressingStyle { get; set; }
        public Dictionary<int, string> ListProfileManager { get; set; }
    }
}
